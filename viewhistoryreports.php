...
<html>
    ...
    <h2 style = "text-align:center;color:black" >RESOLVED FACILITY REPORT</h2>
        ...
        $sql = "SELECT * FROM room_reports WHERE room_reports_status = '1'";
        ...
        $sql = "SELECT * FROM room_reports WHERE room_reports_status = '1' ORDER BY room_reports_created_at ASC LIMIT " . $this_page_first_result . ',' . $results_per_page;
        $result = mysqli_query($conn, $sql);
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <div class = 'w3-dropdown-hover' style = 'float:middle'>
                <button class='w3-button w3-cyan ' style = 'padding:5px:'>Resolved <span class = 'glyphicon glyphicon-arrow-down'></button>
                <div class='w3-dropdown-content w3-bar-block'>
                <a href=\"../php script/unresolvereport.php?room_reports_id=".$row['room_reports_id']."\"class='w3-bar-item w3-indigo'>Unresolved</a></option>
                <a href=\"../php script/deletereport.php?room_reports_id=".$row['room_reports_id']."\"class='w3-bar-item w3-indigo'>Delete</a></option>
                </div>
            </div>
            </td></tr>";
